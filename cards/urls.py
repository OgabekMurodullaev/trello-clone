...
from cards.views import CardListCreateAPIView, CardDetailAPIView, AddCardMemberAPIView, RemoveCardMemberAPIView, AttachmentListCreateAPIView
...
urlpatterns = [
    ...
    path('<int:card_id>/attachments/', AttachmentListCreateAPIView.as_view(), name="attachments_list_create"),
